...
pub struct Acpi<M: ::driver_api::PhysicalMappingTrait<::beskar_core::arch::paging::M4KiB>> {
    madt: ParsedMadt,
    fadt: ParsedFadt,
...
impl<M: ::driver_api::PhysicalMappingTrait<::beskar_core::arch::paging::M4KiB>> Acpi<M> {
    #[must_use]
